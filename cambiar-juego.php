            ...
            <div class="col-md-8">
                ...
                <?php
                    ...
                    if(isset($_GET["id"]) && !empty($_GET["id"])){
                        ...
                        if($res){
                ?>
                        <form action="logica/cambiar-juego.php" method="POST"> 
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="descripcion" name="descripcion" cols="40" rows="1" class="form-control" required="required"><?php echo $res->descripcion; ?></textarea>
                            </div>
                            <div class="form-group">
